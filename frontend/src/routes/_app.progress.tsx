    ...
    <>
      ...
      <main className="space-y-6 p-4 md:p-6">
        ...
        <Card className="shadow-soft">
          <CardHeader>
            <CardTitle>Current vs Target Level</CardTitle>
            <CardDescription>How close are you on each skill?</CardDescription>
          </CardHeader>
              ...
              <CardContent className="p-5">
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    <div className="font-display text-2xl font-bold text-primary">{s.level}%</div>
                ...
                <div className="mt-2 flex justify-between text-xs text-muted-foreground">
                  <span>Current</span>
                  <span>{Math.round((s.level / s.target) * 100)}% of goal</span>
                </div>
              </CardContent>
            </Card>
          ))}
